---
title: "Patterns in ggplot"
output:
  xaringan::moon_reader:
    seal: false
    css:
      - default
      - css/patterns-theme.css
      - css/fonts.css
    lib_dir: libs
    nature:
      ratio: 16:9
...
---
.pull-left[
```{r plot_pattern_01, fig.show='hide', dpi=300}
lines = tibble(
  x = seq(0, 19, by = .5),
  xend = x,
  y =  c(rep(c(5, 10), 19), 5),
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_01", "png")`)
]

.footer-spokes[**SPOKES: PATTERN 01**]
---
.pull-left[
```{r, plot_pattern_03, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_03", "png")`)
]

.footer-spokes[**SPOKES: PATTERN 03**]
---
.pull-left[
```{r, plot_pattern_10, fig.show='hide', warning=FALSE, dpi=300, fig.align='center', out.width= "100%"}
increment = .05
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_10", "png")`)
]

.footer-spokes[**SPOKES: PATTERN 10**]
---
.pull-left[
```{r, plot_pattern_15, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
num_lines = 80
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_15", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_16, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
num_lines = 80
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_16", "png")`)
]

.footer-spokes[**SPOKES: PATTERN 16**]
---
.pull-left[
```{r, plot_pattern_17, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
num_lines = 80
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_17", "png")`)
]

.footer-spokes[**SPOKES: PATTERN 17**]
---
.pull-left[
```{r, plot_pattern_18, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
num_lines = 40
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_18", "png")`)
]

.footer-spokes[**SPOKES: PATTERN 18**]
---
.pull-left[
```{r, plot_pattern_28, fig.show='hide'}
cols = tibble(
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_28", "png")`)
]
...
---
.pull-left[
```{r plot_pattern_02, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
num_lines = 10
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_02", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_08, fig.show='hide', warning=FALSE}
num_lines = 20
...
knitr::include_graphics("../outputs/pattern_8.png")
```
]
...
---
.pull-left[
```{r, plot_pattern_11, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
rings = tibble(
  x = 1,
  xend = 5,
  y = c(2, 5),
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_11", "png")`)
]

.footer-paths[**PATHS: PATTERN 11**]
---
.pull-left[
```{r, plot_pattern_12, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
rings = tibble(
  x = 1,
  xend = 3,
  y = c(2, 4),
...
ggplot() +
  ...
  labs(caption = "Ijeamaka Anyene | @ijeamaka_a") +
  coord_polar() +
  apply_pattern_theme(bg_hex = "#2a534a",
                      caption_hex = "white")
```
]

.pull-right[
![](`r knitr::fig_chunk("plot_pattern_12", "png")`)
]

.footer-paths[**PATHS: PATTERN 12**]
---
.pull-left[
```{r, plot_pattern_26, fig.show='hide'}
ggplot() +
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_26", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_30, fig.show='hide', fig.align='center', out.width= "100%", dpi = 300}
num_lines = 20
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_30", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_05, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
circle = tibble(
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_05", "png")`)
]
.footer-illusion[**ILLUSION: PATTERN 05**]

---
.pull-left[
```{r, plot_pattern_07, fig.show='hide', warning=FALSE, dpi=300, fig.align='center', out.width= "100%"}
circle = tibble(
...
<br>
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_07", "png")`)
]

.footer-illusion[**ILLUSION: PATTERN 07**]
---
.pull-left[
```{r, plot_pattern_13, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
hori_lines = tibble(
  x = seq(-1, 1, by = .08),
  xend = seq(1, -1, by = -.08),
  y = -1, yend = 1)
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_13", "png")`)
]
...
```
.pull-left[
```{r, plot_pattern_20, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
top = circle %>%
  filter(y > 0) %>%
  mutate(x = x, y = y, xend = x) %>%
  select(x, y, xend, type)
...
crosswalk = tibble(
  top = c(seq(1, 15), seq(46, 60)),
  bottom = c(seq(30, 16), seq(45, 31)))

total_lines = left_join(crosswalk, top, 
                        by = c("top" = "type")) %>%
  left_join(., bottom, by = c("bottom" = "type")) %>%
  mutate(size = c(seq(2, 0.1, length.out = 15),
                  seq(0.1, 2, length.out = 15)))
  
ggplot() +
  geom_segment(data = total_lines,
               aes(x = x, y = y,
                   xend = xend, yend = yend,
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_20", "png")`)
]

.footer-illusion[**ILLUSION: PATTERN 20**]
---
.pull-left[
```{r, plot_pattern_21, fig.show='hide'}
circle = tibble(
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_21", "png")`)
]
...
.pull-left[
```{r, plot_pattern_22, fig.show='hide'}
circle_top = circle %>%
  filter(y >= 0)
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_22", "png")`)
...
.pull-left[
```{r, plot_pattern_24, fig.show='hide', fig.width=5.7, fig.height=5, fig.align='center'}
...
<br>
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_24", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_06, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
circle = tibble(
  x = 0,
  y = 0,
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_06", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_23, fig.show='hide'}
waves = tibble(
  x = seq(0, 4, by = .25),
  t = 3*pi,
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_23", "png")`)
]
...
---
.pull-left[
```{r plot_pattern_04, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_04", "png")`)
]

.footer-areas[**AREA: PATTERN 04**]
---
.pull-left[
```{r, plot_pattern_09, fig.show='hide', warning=FALSE, dpi=300, fig.align='center', out.width= "100%"}
area = tibble(
  x = c(1, 2, 1.5),
  y = c(1, .5, .25),
  type = LETTERS[1:3])
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_09", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_14, fig.show='hide', dpi=300, fig.align='center', out.width= "100%", warning=FALSE}
area = tibble(
  x = c(1, 2, 3),
  y = c(1, .5, .25),
  type = LETTERS[1:3])
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_14", "png")`)
]

.footer-areas[**AREA: PATTERN 14**]
---
.pull-left[
```{r, plot_pattern_19, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
outline = tibble(
  x = 1, xend = 7,
  y = 15, yend = 15)
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_19", "png")`)
]

.footer-areas[**AREA: PATTERN 19**]
---
.pull-left[
```{r, plot_pattern_25, fig.show='hide'}
ggplot() +
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_25", "png")`)
]

.footer-areas[**AREA: PATTERN 25**]
---
.pull-left[
```{r, plot_pattern_27, fig.show='hide', warning=FALSE}
cols = tibble(
  x = 1:5,
  y = 5:1,
  type = LETTERS[1:5])
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_27", "png")`)
]

.footer-areas[**AREA: PATTERN 27**]
---
.pull-left[
```{r, plot_pattern_29, fig.show='hide', fig.align='center', out.width= "100%", dpi = 300}
ggplot() +
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_29", "png")`)
]
