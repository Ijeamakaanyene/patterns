---
title: "radial patterns in ggplot"
output:
...
---
.pull-left[
```{r, plot_pattern_32, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
num_lines = 1000
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_32", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_21, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
circle = tibble(
...
.pull-left[
```{r, plot_pattern_22, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
circle_top = circle %>%
  filter(y >= 0)
...
.pull-left[
```{r, plot_pattern_24, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
...
---
.pull-left[
```{r, plot_pattern_31, fig.show='hide', dpi = 300, fig.align='center', out.width= "100%"}
num_lines = 4000
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_31", "png")`)
]

.footer-illusion[**ILLUSION: PATTERN 31**]
---
.pull-left[
```{r, plot_pattern_33, fig.show='hide', dpi=300, fig.align='center', out.width= "100%"}
num_lines = 100
r = 1
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_33", "png")`)
]
...
---
.pull-left[
```{r, plot_pattern_34, fig.show='hide', fig.align='center', out.width= "100%", dpi = 300}
num_lines = 400
...
.pull-right[
![](`r knitr::fig_chunk("plot_pattern_34", "png")`)
]
